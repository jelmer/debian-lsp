...
pub struct ChangeContext<'a> {
    ...
    pub deb822: Option<Deb822ChangeIndex>,
    pub changelog: Option<&'a ChangeLog>,
    pub yaml: Option<&'a yaml_edit::YamlFile>,
    pub watch: Option<&'a debian_watch::parse::ParsedWatchFile>,
    pub changed_ranges: Option<&'a [rowan::TextRange]>,
}
...
pub fn triggers_match(triggers: &'static [Trigger], rel: &Path, ctx: &ChangeContext<'_>) -> bool {
...
impl Deb822ChangeIndex {
    pub fn build(deb822: &deb822_lossless::Deb822, ranges: &[rowan::TextRange]) -> Self {
    ...
    pub fn matches(&self, paragraph_key: &str, field: &str) -> bool {
        self.entries
            .iter()
